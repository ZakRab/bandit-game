...
export const PERSONAS: Persona[] = [
  {
    ...
    rates: { major: 0.3, adjacent: 0.6, different: 0.65, alumni: 0.45 },
  },
  {
    id: "jordan",
    name: "Jordan",
  ...
  },
  {
    ...
    rates: { major: 0.4, adjacent: 0.6, different: 0.65, alumni: 0.35 },
  },
  {
    id: "sam",
    name: "Sam",
    ...
    rates: { major: 0.35, adjacent: 0.5, different: 0.45, alumni: 0.7 },
  },
  {
    id: "alex",
    name: "Alex",
    ...
    bestConnection: "different",
    bestConnectionLabel: "Different Colleges",
    why: "Games need creative collaborators",
    rates: { major: 0.3, adjacent: 0.6, different: 0.65, alumni: 0.45 },
  },
  {
    id: "taylor",
    ...
    rates: { major: 0.35, adjacent: 0.65, different: 0.5, alumni: 0.7 },
  },
];
